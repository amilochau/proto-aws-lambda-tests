...
namespace Milochau.Proto.Http.GetTests.Internals.Runtime.Context
{
    ...
    {
        private readonly WrapperTextWriter _wrappedStdOutWriter;
        private readonly WrapperTextWriter _wrappedStdErrorWriter;
        ...
        public LogLevelLoggerWriter()
        {
            ...
            var fileDescriptorLogId = Environment.GetEnvironmentVariable("_LAMBDA_TELEMETRY_LOG_FD");
        ...
        {
            _wrappedStdOutWriter.CurrentAwsRequestId = awsRequestId ?? string.Empty;
            _wrappedStdErrorWriter.CurrentAwsRequestId = awsRequestId ?? string.Empty;
        }
